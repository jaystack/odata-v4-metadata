...
var Key = (function (_super) {
    ...
    __decorate([
        serializeAs(mapArray("propertyRef", function (prop, i) { return new PropertyRef(prop, i); })), 
        __metadata('design:type', Array)
...
var EntityType = (function (_super) {
    ...
    __decorate([
        serializeAs(new AttributeFunctionChain(function (d, i) { return d.key; }, function (props, i) { return props || []; }, function (props, i) { return props.map(function (prop) { return new Key(prop, i); }); }, function (props) { return props[0]; })), 
